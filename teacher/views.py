...
def teacher(request):#this section for my appointment
	...
	if "Teacher" == group_name:
		...
		return render(request, 'attorney.html', appointments )
	else:
...
def teacher_appointment_list(request):
	...
	if "Teacher" == group_name:
		...
		return render(request, 'attorney_create_appointment.html', appointments )
	else:
		return redirect('http://127.0.0.1:8000/')
...
def teacher_appointment_update(request,id):
	...
	if "Teacher" == group_name:
		...
		return render(request, 'attorney_appointment_update.html', appointments )
	else:
		return redirect('http://127.0.0.1:8000/')